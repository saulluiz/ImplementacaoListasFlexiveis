...
class Program
{
    static void Main(string[] args)
    {
        ...
        listaNormal.InserirInicio(2);
        listaNormal.InserirInicio(1);
        listaNormal.InserirInicio(3);
        listaNormal.InserirFinal(4);
        listaNormal.InserirMeio(100, 1);

        listaNormal.imprimir();
        Console.WriteLine("----------------");
        Console.WriteLine("retornando " + listaNormal.Remove(0));
        Console.WriteLine("retornando " + listaNormal.Remove(3));
        Console.WriteLine("retornando " + listaNormal.Remove(2));
        Console.WriteLine("----------------");
        listaNormal.imprimir();
        ...
        lista.InserirMeio(100, 1);

        lista.Imprimir();
        Console.WriteLine("----------------");
        Console.WriteLine("retornando " + lista.Remove(0));
        Console.WriteLine("retornando " + lista.Remove(3));
        Console.WriteLine("retornando " + lista.Remove(2));
        Console.WriteLine("----------------");
        lista.Imprimir();
        Console.WriteLine("******************************************************");
        ListaDupla listaDupla = new ListaDupla();
        listaDupla.inserirInicio(11);
        Console.WriteLine("removendo Inicio ====================> " + listaDupla.RemoverInicio());
        listaDupla.inserirInicio(12);
        listaDupla.inserirInicio(13);
        listaDupla.inserirInicio(14);
        listaDupla.inserirInicio(15);
        listaDupla.inserirFinal(100);
        listaDupla.inserirFinal(200);
        listaDupla.inserir(999, 2);
        Console.WriteLine("{{}}" + listaDupla.remover(2));
        Console.WriteLine("removendo " + listaDupla.RemoverFinal());
        listaDupla.imprimirReverso();
        System.Console.WriteLine(($"---------------- {listaDupla.count}------------------"));
        listaDupla.imprimir();
        Console.WriteLine("******************************************************");
        ListaDuplaSemCabeca l2 = new ListaDuplaSemCabeca();
        l2.inserirInicio(1);
        l2.inserirInicio(2);
        l2.inserirInicio(3);
        l2.inserirFinal(100);
        l2.inserirFinal(200);
        l2.inserirFinal(300);
        Console.WriteLine("removi o" + l2.RemoverInicio());
        l2.imprimir();
        System.Console.WriteLine(($"---------------- {l2.count}------------------"));
        l2.imprimirReverso();
